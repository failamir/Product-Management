...
class ProductStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.productStatuses.index', compact('productStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.productStatuses.create');
    }
    ...
    public function store(StoreProductStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.product-statuses.index');
    }
    ...
    public function edit(ProductStatus $productStatus)
    {
        ...
        return view('frontend.productStatuses.edit', compact('productStatus'));
    }
    ...
    public function show(ProductStatus $productStatus)
    {
        ...
        return view('frontend.productStatuses.show', compact('productStatus'));
    }
    ...
    {
        $productStatuses = ProductStatus::find(request('ids'));
