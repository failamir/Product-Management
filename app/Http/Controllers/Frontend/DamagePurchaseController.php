...
class DamagePurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.damagePurchases.index', compact('damagePurchases'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.damagePurchases.create', compact('purchases'));
    }
    ...
    public function store(StoreDamagePurchaseRequest $request)
    {
        ...
        return redirect()->route('frontend.damage-purchases.index');
    }
    ...
    public function edit(DamagePurchase $damagePurchase)
    {
        ...
        return view('frontend.damagePurchases.edit', compact('damagePurchase', 'purchases'));
    }
    ...
    public function show(DamagePurchase $damagePurchase)
    {
        ...
        return view('frontend.damagePurchases.show', compact('damagePurchase'));
    }
