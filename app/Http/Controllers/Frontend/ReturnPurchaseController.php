...
class ReturnPurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.returnPurchases.index', compact('returnPurchases'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.returnPurchases.create', compact('purchases'));
    }
    ...
    public function store(StoreReturnPurchaseRequest $request)
    {
        ...
        return redirect()->route('frontend.return-purchases.index');
    }
    ...
    public function edit(ReturnPurchase $returnPurchase)
    {
        ...
        return view('frontend.returnPurchases.edit', compact('purchases', 'returnPurchase'));
    }
    ...
    public function show(ReturnPurchase $returnPurchase)
    {
        ...
        return view('frontend.returnPurchases.show', compact('returnPurchase'));
    }
