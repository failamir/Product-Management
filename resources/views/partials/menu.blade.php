<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('product_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/product-categories*") ? "c-show" : "" }} {{ request()->is("admin/product-tags*") ? "c-show" : "" }} {{ request()->is("admin/suppliers*") ? "c-show" : "" }} {{ request()->is("admin/product-statuses*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }} {{ request()->is("admin/product-ajaxis*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('product_ajaxi_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.product-ajaxis.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/product-ajaxis") || request()->is("admin/product-ajaxis/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-shopping-cart c-sidebar-nav-icon">
        ...
        @can('purchase_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/expenses*") ? "c-show" : "" }} {{ request()->is("admin/purchases*") ? "c-show" : "" }} {{ request()->is("admin/return-purchases*") ? "c-show" : "" }} {{ request()->is("admin/damage-purchases*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-shopping-cart c-sidebar-nav-icon">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('return_purchase_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.return-purchases.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/return-purchases") || request()->is("admin/return-purchases/*") ? "c-active" : "" }}">
                    ...
                    @can('damage_purchase_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.damage-purchases.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/damage-purchases") || request()->is("admin/damage-purchases/*") ? "c-active" : "" }}">
