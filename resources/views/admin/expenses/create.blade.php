    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expenses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('expense_category') ? 'is-invalid' : '' }}" name="expense_category" id="expense_category" required>
                    ...
                    @foreach(App\Models\Expense::EXPENSE_CATEGORY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('expense_category', 'Stationary') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('expense_reason') ? 'is-invalid' : '' }}" name="expense_reason" id="expense_reason">{!! old('expense_reason') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expense_amount') ? 'is-invalid' : '' }}" type="number" name="expense_amount" id="expense_amount" value="{{ old('expense_amount', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('expense_note') ? 'is-invalid' : '' }}" name="expense_note" id="expense_note">{!! old('expense_note') !!}</textarea>
