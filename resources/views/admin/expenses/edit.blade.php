    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expenses.update", [$expense->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('expense_category') ? 'is-invalid' : '' }}" name="expense_category" id="expense_category" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('expense_reason') ? 'is-invalid' : '' }}" name="expense_reason" id="expense_reason">{!! old('expense_reason', $expense->expense_reason) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expense_amount') ? 'is-invalid' : '' }}" type="number" name="expense_amount" id="expense_amount" value="{{ old('expense_amount', $expense->expense_amount) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('expense_date') ? 'is-invalid' : '' }}" type="text" name="expense_date" id="expense_date" value="{{ old('expense_date', $expense->expense_date) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('expense_note') ? 'is-invalid' : '' }}" name="expense_note" id="expense_note">{!! old('expense_note', $expense->expense_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('expense_attachment_no_file_chosen') ? 'is-invalid' : '' }}" id="expense_attachment_no_file_chosen-dropzone">
                </div>
