...
@can('product_ajaxi_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.product-ajaxis.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ProductAjaxi">
            <thead>
                <tr>
                    <th width="10">
...
@can('product_ajaxi_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.product-ajaxis.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.product-ajaxis.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ProductAjaxi').DataTable(dtOverrideGlobals);
