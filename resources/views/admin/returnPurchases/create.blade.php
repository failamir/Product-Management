...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.return-purchases.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="return_reason">{{ trans('cruds.returnPurchase.fields.return_reason') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('return_reason') ? 'is-invalid' : '' }}" name="return_reason" id="return_reason">{!! old('return_reason') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refund_amount') ? 'is-invalid' : '' }}" type="number" name="refund_amount" id="refund_amount" value="{{ old('refund_amount', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('return_note') ? 'is-invalid' : '' }}" name="return_note" id="return_note">{!! old('return_note') !!}</textarea>
