    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchases.update", [$purchase->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_code') ? 'is-invalid' : '' }}" type="text" name="purchase_code" id="purchase_code" value="{{ old('purchase_code', $purchase->purchase_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_name') ? 'is-invalid' : '' }}" type="text" name="product_name" id="product_name" value="{{ old('product_name', $purchase->product_name) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('unit') ? 'is-invalid' : '' }}" name="unit" id="unit" required>
                    ...
                    @foreach(App\Models\Purchase::UNIT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('unit', $purchase->unit) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('unit'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_price') ? 'is-invalid' : '' }}" type="number" name="unit_price" id="unit_price" value="{{ old('unit_price', $purchase->unit_price) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number" name="discount" id="discount" value="{{ old('discount', $purchase->discount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_total') ? 'is-invalid' : '' }}" type="number" name="sub_total" id="sub_total" value="{{ old('sub_total', $purchase->sub_total) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_discount') ? 'is-invalid' : '' }}" type="number" name="total_discount" id="total_discount" value="{{ old('total_discount', $purchase->total_discount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transport_cost') ? 'is-invalid' : '' }}" type="number" name="transport_cost" id="transport_cost" value="{{ old('transport_cost', $purchase->transport_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grand_total') ? 'is-invalid' : '' }}" type="number" name="grand_total" id="grand_total" value="{{ old('grand_total', $purchase->grand_total) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_paid') ? 'is-invalid' : '' }}" type="number" name="total_paid" id="total_paid" value="{{ old('total_paid', $purchase->total_paid) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_method') ? 'is-invalid' : '' }}" name="payment_method" id="payment_method">
                    ...
                    @foreach(App\Models\Purchase::PAYMENT_METHOD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_method', $purchase->payment_method) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('purchase_note') ? 'is-invalid' : '' }}" name="purchase_note" id="purchase_note">{!! old('purchase_note', $purchase->purchase_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\Purchase::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $purchase->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.purchases.storeCKEditorImages') }}', true);
...
Dropzone.options.photoDropzone = {
    url: '{{ route('admin.purchases.storeMedia') }}',
    maxFilesize: 2, // MB
