    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchases.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_code') ? 'is-invalid' : '' }}" type="text" name="purchase_code" id="purchase_code" value="{{ old('purchase_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_discount') ? 'is-invalid' : '' }}" type="number" name="total_discount" id="total_discount" value="{{ old('total_discount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transport_cost') ? 'is-invalid' : '' }}" type="number" name="transport_cost" id="transport_cost" value="{{ old('transport_cost', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_paid') ? 'is-invalid' : '' }}" type="number" name="total_paid" id="total_paid" value="{{ old('total_paid', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('purchase_note') ? 'is-invalid' : '' }}" name="purchase_note" id="purchase_note">{!! old('purchase_note') !!}</textarea>
