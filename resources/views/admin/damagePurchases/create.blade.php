...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.damage-purchases.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="damage_reason">{{ trans('cruds.damagePurchase.fields.damage_reason') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('damage_reason') ? 'is-invalid' : '' }}" name="damage_reason" id="damage_reason">{!! old('damage_reason') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('damage_note') ? 'is-invalid' : '' }}" name="damage_note" id="damage_note">{!! old('damage_note') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('damage_date') ? 'is-invalid' : '' }}" type="text" name="damage_date" id="damage_date" value="{{ old('damage_date') }}">
