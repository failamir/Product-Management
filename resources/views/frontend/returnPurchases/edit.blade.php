    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.return-purchases.update", [$returnPurchase->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="return_reason">{{ trans('cruds.returnPurchase.fields.return_reason') }}</label>
                            <textarea class="form-control ckeditor" name="return_reason" id="return_reason">{!! old('return_reason', $returnPurchase->return_reason) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="return_date" id="return_date" value="{{ old('return_date', $returnPurchase->return_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="refund_amount" id="refund_amount" value="{{ old('refund_amount', $returnPurchase->refund_amount) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="return_note" id="return_note">{!! old('return_note', $returnPurchase->return_note) !!}</textarea>
