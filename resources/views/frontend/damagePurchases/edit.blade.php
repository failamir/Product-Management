    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.damage-purchases.update", [$damagePurchase->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="damage_reason">{{ trans('cruds.damagePurchase.fields.damage_reason') }}</label>
                            <textarea class="form-control ckeditor" name="damage_reason" id="damage_reason">{!! old('damage_reason', $damagePurchase->damage_reason) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="damage_note" id="damage_note">{!! old('damage_note', $damagePurchase->damage_note) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="damage_date" id="damage_date" value="{{ old('damage_date', $damagePurchase->damage_date) }}">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.damage-purchases.storeCKEditorImages') }}', true);
...
Dropzone.options.photoDropzone = {
    url: '{{ route('frontend.damage-purchases.storeMedia') }}',
    maxFilesize: 2, // MB
