        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.damagePurchase.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.damage-purchases.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="damage_reason">{{ trans('cruds.damagePurchase.fields.damage_reason') }}</label>
                            <textarea class="form-control ckeditor" name="damage_reason" id="damage_reason">{!! old('damage_reason') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="damage_note" id="damage_note">{!! old('damage_note') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="damage_date" id="damage_date" value="{{ old('damage_date') }}">
