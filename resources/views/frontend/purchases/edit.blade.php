                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchases.update", [$purchase->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="purchase_code" id="purchase_code" value="{{ old('purchase_code', $purchase->purchase_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $purchase->purchase_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="product_name" id="product_name" value="{{ old('product_name', $purchase->product_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="quantity" id="quantity" value="{{ old('quantity', $purchase->quantity) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="unit_price" id="unit_price" value="{{ old('unit_price', $purchase->unit_price) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="discount" id="discount" value="{{ old('discount', $purchase->discount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sub_total" id="sub_total" value="{{ old('sub_total', $purchase->sub_total) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_discount" id="total_discount" value="{{ old('total_discount', $purchase->total_discount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="transport_cost" id="transport_cost" value="{{ old('transport_cost', $purchase->transport_cost) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="grand_total" id="grand_total" value="{{ old('grand_total', $purchase->grand_total) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_paid" id="total_paid" value="{{ old('total_paid', $purchase->total_paid) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="purchase_note" id="purchase_note">{!! old('purchase_note', $purchase->purchase_note) !!}</textarea>
