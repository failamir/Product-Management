                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.expenses.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="expense_reason" id="expense_reason">{!! old('expense_reason') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="expense_amount" id="expense_amount" value="{{ old('expense_amount', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="expense_date" id="expense_date" value="{{ old('expense_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="expense_note" id="expense_note">{!! old('expense_note') !!}</textarea>
