                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('product_status_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.product-statuses.index') }}">
                                    ...
                                    @endcan
                                    @can('product_ajaxi_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.product-ajaxis.index') }}">
                                            {{ trans('cruds.productAjaxi.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @endcan
                                    @can('purchase_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.purchases.index') }}">
                                            {{ trans('cruds.purchase.title') }}
                                        </a>
                                    @endcan
                                    @can('return_purchase_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.return-purchases.index') }}">
                                            {{ trans('cruds.returnPurchase.title') }}
                                        </a>
                                    @endcan
                                    @can('damage_purchase_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.damage-purchases.index') }}">
                                            {{ trans('cruds.damagePurchase.title') }}
                                        </a>
                                    @endcan
